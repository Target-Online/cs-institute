      ...
      <Block flex style={styles.container}>
        ...
        <Block flex space="between" style={styles.padded}>
          <Block flex space="around" style={{ zIndex: 2 }}>
            <ScrollView>
              <Block>
                <Text color="black" size={30}>CS Institute</Text>
              </Block>
              <Block row>
                <Text color="black" size={30}>End-User License Agreement</Text>
              </Block>
              <Text p style={{marginBottom: theme.SIZES.BASE / 2}}>
                Last updated: April 05, 2020
                Please read this End-User License Agreement carefully before clicking the "I Agree" button, downloading or using CS Institute.
              ...
              <Text p style={{marginBottom: theme.SIZES.BASE / 2}}>
                ...
                Agreement means this End-User License Agreement that forms the entire agreement between You and the Company regarding the use of the Application. This Agreement has been created with the help of EULA Generator.
                Application means the software program provided by the Company downloaded by You to a Device, named CS Institute
                Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to CS Institute.
              ...
              By visiting this page on our website: targetonline.co.za
              EULA of CS Institute
              </Text>
            </ScrollView>
