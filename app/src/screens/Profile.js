...
import { _pickUserAvatar } from '../shared/utils/imageUtils'
...
export default function View (props) {
    ...
    const [avatarUpdate, setAavatarStatus] = useState(false);
    ...
    return (
        <Block flex style={styles.profile}>
            <Block flex>
                <TouchableOpacity onPress={() => _pickUserAvatar(setImage, currentUser, setAavatarStatus)}>
                    <Spinner childStyles={{ marginTop: 100 }} inProgress={avatarUpdate}>
                        <ImageBackground
